...
(1, 'full', 'Standard Redactor-Konfiguration', '300', '800', 'relative', 'alignment,blockquote,bold,cleaner,clips[Snippetname1=Snippettext1|Snippetname2=Snippettext2],deleted,emaillink,externallink,fullscreen,groupheading[1|2|3|4|5|6],grouplink[email|external|internal|media],heading1,heading2,heading3,heading4,heading5,heading6,horizontalrule,internallink,italic,limiter[300],media,medialink,orderedlist,properties,source,table,textdirection,underline,unorderedlist');
