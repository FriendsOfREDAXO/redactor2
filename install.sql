...
INSERT IGNORE INTO `%TABLE_PREFIX%redactor2_profiles` (`id`, `name`, `description`, `minheight`, `maxheight`, `characterlimit`, `urltype`, `shortcuts`, `linkify`, `redactor_plugins`) VALUES
